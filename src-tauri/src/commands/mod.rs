...
pub use handlers::{
    ...
    query_workshop_details, query_workshop_home, query_workshop_item, query_workshop_items,
    record_workshop_items_seen, rename_addon, rename_addons, save_background_task_snapshot,
    save_settings, steam_sync, toggle_addons,
};
