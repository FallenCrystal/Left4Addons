...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            commands::handlers::get_settings,
            ...
            commands::handlers::rename_addons,
            commands::handlers::group_action,
            ...
            commands::handlers::fetch_collection,
            commands::handlers::add_known_addon,
            commands::handlers::get_workshop_cache,
            commands::handlers::record_workshop_items_seen,
