...
- 内置下载:
  - 更高的并发限制可能会导致得到 Too many requests, 下载限速/暂停等问题. 在共享网络/加速器上更为常见.  
    如果默认的2并发限制仍然遇到下载问题, 请调整为1或等待自动重试和断点续传
